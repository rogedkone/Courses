...
elif num % 100 == 1 or num == 1 or num % 10 == 1 and num % 100 > 20:
    print(num, 'программист')
elif num % 10 >= 2 and num % 10 <= 4 and num % 100 >= 2 and num % 100 <= 4 or num % 100 >= 20 and num % 10 >= 2 and num % 10 <= 4:
    print(num, 'программиста')
elif num >= 5 and num % 100 != 0:
    print(num, 'программистов')
